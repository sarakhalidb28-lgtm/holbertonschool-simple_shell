...
Simple Shell is a simplified UNIX command interpreter written in C.  
The purpose of this project is to understand how shells work internally, how commands are executed, and how processes communicate with the operating system.
...
These functions are used for reading input, creating processes, executing commands, managing memory, and handling errors.
...
<p align="center">
  <img width="750" src="https://github.com/user-attachments/assets/be4f3bbc-493f-431b-aecb-fbb0e02341da" />
</p>
